...
<head>
    <meta charset="utf-8">
    <title>@yield('title') - SIPADU {{Auth::user()->desa->nama_desa}}</title>
...
<header class="app-header dark indigo box-shadow-y">
    <div class="navbar navbar-expand-lg">

        <!-- Page title -->
        <!-- brand -->
        <a href="{{url('/')}}" class="navbar-brand">
            <b class="text-white">{{Auth::user()->desa->nama_desa}}</b>
        </a>
        <!-- / brand -->
        ...
        <!-- Navbar collapse -->
        <div class="collapse navbar-collapse navbar-dark  order-lg-1" id="navbarToggler">
            ...
            <!-- <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link  dropdown-toggle" data-toggle="dropdown">
                        <i class="fa  fa-empire"></i> Layanan Pemerintahan
                    </a>
                    <div class="dropdown-menu dropdown-menu-right mt-2 text-color" role="menu">
                        <!--
                        <a href="/jenis-surat" class="dropdown-item">
                        ...
                        -->
                        <a href="http://www.bpkp.go.id/sakd/konten/2448/Pengawalan-Keuangan-Desa-dengan-Aplikasi-SISKEUDES.bpkp" class="dropdown-item">
                            <i class="fa fa-empire"></i>
                            SISKEUDES
                        </a>

                        <a href="http://prodeskel.binapemdes.kemendagri.go.id/mpublik/" class="dropdown-item">
                            <i class="fa fa-empire"></i>
                            PRODESKEL
                        </a>

                        <a href="http://epdeskel.kemendagri.go.id/app_Login/" class="dropdown-item">
                            <i class="fa fa-empire"></i>
                            EPDESKEL
                        </a>
                    </div>
