                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="box-color green">
                                <div class="box-body text-white ">
                                        <h1>{{number_format($jml_penduduk, 0, ',', '.')}}</h1>
                                        <span style="font-size: 12pt;"><i class="fa fa-users"></i> Jumlah Penduduk</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="box-color blue">
                                <div class="box-body text-white ">
                                    <h1>{{number_format($jml_keluarga, 0, ',', '.')}}</h1>
                                    <span style="font-size: 12pt;"><i class="fa fa-home"></i> Jumlah Keluarga</span>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="box-color deep-orange">
                                <div class="box-body text-white ">
                                    <h1>{{number_format($jml_duktang, 0, ',', '.')}}</h1>
                                    <span style="font-size: 12pt;"><i class="fa fa-suitcase"></i> Jumlah Penduduk Pendatang</span>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="box-color deep-purple">
                                <div class="box-body text-white ">
                                    <h1>{{number_format($jml_surat, 0, ',', '.')}}</h1>
                                    <span style="font-size: 12pt;"><i class="fa fa-envelope"></i> Jumlah Surat Tercetak</span>
                                </div>
                            </div>
                        </div>
